...
export default function Post(props){
  return(
    <div className='flex flex-row'>
        <div className="grid grid-cols-1  bg-white m-2 mr-0 p-2 rounded-full basis-1/6 h-26 votos  text-violet-400">
          ...
          <div className='text-center -my-1 text-black'>32</div>
          ...
          <ul>
            ...
            <li className='flex font-normal text-white space-x-1 text-sm'>
              <div className='bg-red-500 rounded-lg px-1'>
                ...
                <div className='bg-violet-600 rounded-lg px-1'>Tags</div>
            </li>
          </ul>
        </div>
      </div>
